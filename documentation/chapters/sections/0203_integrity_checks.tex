...
\sectionnames{Simon Fallnich}
	...
	\label{subsec:merkle-tree}
		...
		A \emph{Merkle} tree, or \emph{hash tree}, is a tree in which every leaf node stores the hash of a data block and every non-leaf node stores the hash of the hashes of its children \cite{merkle1987}.
