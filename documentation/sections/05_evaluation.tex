\section{Evaluation}
In this section, we are going to discuss how our evaluation process looked like.
We automatized the benchmarking, so our benchmarks are repeatable and easy to execute.
...
As proposed we want to save those state variables off from the blockchain and thus save on gas which explains why gas cost are our most important measurement.
