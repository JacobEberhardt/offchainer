...
contract EmployeeOnchain {
	 ...
	 */
	function add(string firstName, string lastName, uint256 startDate, bytes32 department, uint256 salary) public {
	 ...
	 */
	function update(uint _index, string firstName, string lastName, uint256 startDate, bytes32 department, uint256 salary) public {
